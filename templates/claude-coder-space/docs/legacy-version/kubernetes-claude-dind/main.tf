...
# This template combines Docker-in-Docker (via Envbox) with Claude Code AI features
# The Claude Code module does automatic task reporting
...
module "claude-code" {
  ...
  # Pass authentication to the module
